  ...
  return (
    <section id="about" className="about">
      <div className="aboutContainer">
        <div className="aboutContainerImg"></div>
        ...
        <div className="aboutContainerDetails">
          ...
          <p>
            Orgulhosos de nossas raízes e da paixão que temos por criar queijos excepcionais, estamos constantemente em busca de inovação sem jamais abrir mão da tradição. Bem-vindo ao universo Bemjequi, onde cada mordida é uma viagem ao coração do interior do Vale Jequitionha.
          </p>
        </div>
      </div>
